...
home_body = f'''    <main>
      ...
      <section class="section">
        ...
        <div class="nav-cards">
          ...
          <a class="nav-card" href="/intelligence/#today"><div><div class="nav-card-title">Morning Intelligence</div><div class="nav-card-sub">An automated daily briefing across markets, India, companies, AI, and geopolitics.</div></div><span class="nav-card-arrow">&rarr;</span></a>
        </div>
      </section>
