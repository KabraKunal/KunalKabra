    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Commercial negotiation still matters. It is simply a lagging intervention. Practitioner research from McKinsey argues that supplier switching and price tactics often capture less than half of the full potential in indirect categories; demand and specification can matter more. I would not treat a consulting benchmark as a universal law, but the direction is right.",
      ...
      },
      {
        ...
        closingParagraphs: [
          "In Flexera's 2026 vendor survey of 753 cloud decision-makers, respondents estimated that 29% of IaaS and PaaS spend was wasted. The sample is vendor-led and weighted toward the United States, but the direction reinforces the point: usage matters as much as negotiated rate.",
        ],
      },
      {
        title: "Tail spend is a product problem",
        paragraphs: [
          "McKinsey estimates that roughly one-fifth of indirect spend can be spread across four-fifths of the vendor list. The exact ratio will vary by company, but the underlying pattern is familiar: thousands of low-value transactions create disproportionate operational work.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "TSMC's 2025 annual report offers a useful signal. Processes at 7 nanometres and below accounted for 74% of wafer revenue, while the company invested in both leading-edge nodes and advanced packaging such as CoWoS and 3D integration. Progress is no longer only a smaller transistor. It is a joint product of process yield, chiplets, memory proximity, packaging and software.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "The IEA's 2026 update expects global data-centre electricity use to double by 2030, with use from AI-focused data centres more than tripling. That is a forecast, not destiny, and constraints will be local. But the direction matters: electricity is becoming part of computing architecture.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Falling token prices do not imply falling infrastructure demand. Stanford's 2025 AI Index found that the price of querying a model scoring at GPT-3.5 level on MMLU fell more than 280-fold between November 2022 and October 2024. Cheaper intelligence can expand usage and make reasoning loops and agents economical; whether aggregate demand rises depends on usage growth outrunning efficiency.",
          "Alphabet reported that it reduced the unit cost of serving Gemini by 78% during 2025 through model optimisation, efficiency and utilisation. The number is company-reported, but the mechanism is the important part: competitive advantage can come from the entire serving system, not only the underlying model.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "After auditing 138 problems that o3 did not consistently solve, OpenAI found material test or problem issues in at least 59.4% of that failure-prone set and stopped reporting SWE-bench Verified for frontier launches. Stanford's 2026 AI Index similarly describes rapid benchmark saturation and meaningful rates of invalid questions across prominent evaluations. The lesson is not that evaluation is useless. It is that an evaluation must evolve with the system it measures.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Sarvam says its 30B and 105B mixture-of-experts models were trained entirely in India on IndiaAI compute and released under Apache 2.0. The 30B model activates roughly 2.4 billion parameters per token and the 105B roughly 10.3 billion. Active parameters are a rough proxy for mixture-of-experts compute per token, not the memory footprint of the full model—a distinction that matters when judging deployment economics.",
          ...
          "As of August 2026, Sarvam-M and the hosted Sarvam-30B endpoint are deprecated in favour of Sarvam-105B, although their downloadable weights remain available. That is normal in a fast-moving market. Every model dependency should be assumed temporary even when the underlying weights remain available.",
        ],
      },
      {
...
export const searchItems = [
  ...
  },
  {
    type: "Page",
    title: "About",
    description: "Background, path, working beliefs, and ways to get in touch.",
    href: "/about",
  },
  ...essays.map((essay) => ({
    type: "Essay",
