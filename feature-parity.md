...
| Essays and essay detail routes | Preserved | Canonical routes live under `/writing`; the archive contains the three concise original essays. Old `/essays` paths still redirect without breaking shared links. |
...
| About, beliefs, contact | Preserved | Biography, beliefs, email, and LinkedIn are retained in the redesigned hierarchy. |
...
- Main production build and parity suite: 9/9 passing.
- Morning Intelligence build and smoke suite: 2/2 passing.
- Browser captures cover the canonical routes at desktop and mobile widths; all return HTTP 200.
